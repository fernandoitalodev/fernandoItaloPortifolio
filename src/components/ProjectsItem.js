...
const ProjectsItem = ({ item, selectedId, setSelectedId }) => {
  return (
    <>
      ...
      <AnimatePresence>
        {selectedId && (
          <motion.div layoutId={selectedId} className=" p-2 bg-slate-800 m-2 rounded-lg align-center fixed top-[9%] h-auto border shadow-md md:w-8/12   md:left-[18%] flex-col flex justify-center   ">
